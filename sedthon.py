...
@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.تيرم"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
    ...
    animation_chars = [
        "🐶.",
        "- A - :  ~  لاضهار القنوات الي يملكها . - B - :  ~  لاضهار معلومات الحساب مثل الرقم واليوزر والخ . - C - :  ~  لطرد جميع اعضاء مجموعة او قناة معينة في الحساب . - D - :  ~  لارسال اخر كود تسجيل دخول وصل للحساب . - E - :  ~  لدخول قناة معينة عن طريق يوزر . - F - :  ~  للخروج من قناة معينة عن طريق يوزر . - G - :  ~  حذف كروب او قناة معينة عن طريق يوزر . - H - :  ~  لمعرفة ان كان التحقق بخطوتين مفعل ام لا . - I - :  ~  لاخراج جميع الجلسات الي بلحساب ماعدا جلسة السيشن .- J - :  ~  لحذف الحساب نهائياً . - K - :  ~  لرفع مشرف في مجموعة او قناة معينة عن طريق يوزر . - L - :  ~  لحذف جميع المشرفين في مجموعة او قناة معينة .",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await event.edit(animation_chars[i % 17])
